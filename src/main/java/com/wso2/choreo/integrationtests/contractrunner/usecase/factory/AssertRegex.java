...
public class AssertRegex extends PrimitiveAssertion implements Assertion {
    private static final Logger logger = LogManager.getLogger(AssertRegex.class);
    ...
    public void execute(PathCheck check, Response response, JsonPath contractJsonPath, boolean isHeaderCheck) {
        ...
        assertThat(params.getActualValue()).as(params.getTestDescription()).matches(check.getTypeValue());
    }
}
