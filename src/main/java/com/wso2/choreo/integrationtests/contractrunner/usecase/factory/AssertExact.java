...
public class AssertExact extends PrimitiveAssertion implements Assertion {
    private static final Logger logger = LogManager.getLogger(AssertExact.class);
    ...
    public void execute(PathCheck check, Response response, JsonPath contractJsonPath, boolean isHeaderCheck) {
        ...
        assertThat(params.getActualValue()).as(params.getTestDescription()).isEqualTo(params.getExpectedValue());
    }
}
